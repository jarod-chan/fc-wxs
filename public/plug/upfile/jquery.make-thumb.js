	...
	return function (){
		...
		file.makeThumb({
			...
			success: function(dataURL, tSize, file, sSize, fEvt) {
				...
				var html = '<div class="img_ck" id="'+id+'"><img class="up_img" src="'+dataURL+'"/><span class="close_span"  onclick="remove_del('+id+')"><img src="'+FYG_PATH+'plug/upfile/close.png'+'"/></span><input type="hidden" name="file[]" value="'+dataURL+'" /></div>';
				img_div.append(html);
				file_len=file_len+1;
			}
		});
